...
namespace ServicioTerreno
{
    ...
    public class Service1 : IService1
    {
        ...
        public Boolean EliminarLoteContrato(int idLote)
        {
            return Model.DAO.LoteDAO.EliminarLoteContrato(idLote);
        }
        ...
        public List<ContratoPersona> ListarContratoPersona()
        {
            return Model.DAO.PersonaDAO.ObtenerPersonasContrato();
        }
        public List<Terreno> ListarTerrenoContrato(int IdContrato)
        {
